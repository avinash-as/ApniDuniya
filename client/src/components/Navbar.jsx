  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
      <Link to='/' className='max-md:flex-1'>
          <h1 className='text-3xl font-extrabold bg-gradient-to-r from-red-500 to-yellow-400 bg-clip-text text-transparent'>
             ApniDuniya
          </h1> 
      </Link>
      ...
      <MenuIcon className='max-md:ml-4 m                              d:hidden w-8 h-8 cursor-pointer' onClick={()=> setIsOpen(!isOpen)}/>
